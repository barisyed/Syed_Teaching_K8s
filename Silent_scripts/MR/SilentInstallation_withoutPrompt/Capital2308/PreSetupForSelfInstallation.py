...
def BuildZipName():
    ...
    return entries[0] # Return the name of the first entry in the "Win64" subdirectory
...
rootdir = r'\\inh\dfs\nobackup\iesd_release\chsrelease\iterationReleases\CHS_Iteration_rel\Capital'
