...
file_path = r'C:\apps\Digital_testing_capital_2308.csv'
Validation(file_path)
file_path = r'C:\apps\Digital_testing_capital_2207.csv'
Validation(file_path)
file_path = r'C:\apps\Digital_testing_capital_2021.csv'
Validation(file_path)
file_path = r'C:\apps\Digital_testing_capital_2020.csv'
Validation(file_path)
